...
if __name__ == "__main__":
    # parser = argparse.ArgumentParser(description="Learn GAT-based GNN embeddings from disease and multiple disease similarity networks")
    # parser.add_argument('--embedding_size', type=int, default=256, help='Size of the embedding vectors')
    # parser.add_argument('--epochs', type=int, default=5, help='Number of training epochs for GAT')
    # parser.add_argument('--disease_sim_file', type=str, default="../Data/DiseaseSimNet_OMIM.txt", help='Path to disease similarity file')
    
    # args = parser.parse_args()
    # print(f"args.embedding_size: {args.embedding_size}, args.epochs: {args.epochs}")
    # main(
    ...
    disease_sim_file = "../Data/DiseaseSimNet_OG.txt"#DiseaseSimNet_OG/DiseaseSimNet_OHG/DiseaseSimNet_GeneNet/DiseaseSimNet_HPO/DiseaseSimNet_OMIM
